...
pub enum ChaosOperation {
    ...
    RwLockDowngrade,
    RwLockDeadlock,
    RwLockWriterStarvation,
    RwLockReaderStarvation,
    SemaphoreAcquire,
    SemaphoreTryAcquire,
    SemaphoreAcquireMany,
    ...
    RuntimeDeadlock,
    RuntimeBlock,
    RuntimeThreadExhaustion,
    RuntimeMemoryExhaustion,
    RuntimeCpuExhaustion,
    StreamNext,
    StreamCollect,
    StreamTimeout,
    StreamThrottle,
    ...
    SplitBrainPartition,
    SplitBrainHealing,
    ThunderingHerdTrigger,
    ThunderingHerdAmplify
}
